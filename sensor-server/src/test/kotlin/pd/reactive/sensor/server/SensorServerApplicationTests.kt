    ...
    fun setUp() {
        runBlocking {
            ...
            sensorDataRepository.saveAll(
                listOf(
                    SensorData(21, "room", twoSecondBeforeNow),
                    SensorData(20, "room", secondBeforeNow),
                    SensorData(19, "room", now)
                )
            ).toList()
        }
    }
            ...
            sensorDataRepository.findAll()
                ...
                .apply {
                    assertThat(this.testVersion())
                        .isEqualTo(SensorData(18, "garage", now.plusSeconds(1).noMillis()))
                }
        }
    }
